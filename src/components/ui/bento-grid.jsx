    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
		  How do credits work at Westmoor High School?
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500 ml-4">Semester courses are 5 units, and year-long courses are 10 credits.</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
...
const SkeletonFive = () => {
  ...
  const second = {
    ...
    >
      ...
      >
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-gray-500 to-orange-500 flex-shrink-0" />
      ...
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-teal-500 to-fuchsia-500 flex-shrink-0" />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
			Up in Chicago!
        </p>
...
const items = [
  {
    ...
    description: (
	  ...
	  With hourly backups to cloud storage and data being processed real-time, you can be assured that your data is in safe hands.
      </span>
    ),
    header: <SkeletonOne />,
    className: "md:col-span-1",
    icon: <svg xmlns="http://www.w4.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="size-6">
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        A simple-to-use interface that allows everyone to be able to manage their academic progress.
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
		New courses and changes to course schedules are always added to the website.
      </span>
    ),
  ...
  {
    title: "Rammy: Your AI Mentor",
    description: (
      <span className="text-sm">
        Trained with knowledge about Westmoor and this site, you can ask Rammy about anything: from advice to specific information about using the calculator.
      </span>
    ),
    header: <SkeletonFour />,
